...
export const StatusBar: React.FC<StatusBarProps> = ({
  ...
  return (
    <div
      className="flex flex-row h-6 leading-6 w-full text-xs font-mono overflow-hidden border-b border-[rgba(128,128,128,0.2)] select-none px-2 box-border"
      style={style}
    >
      ...
      >
        <span
          className={`w-2 h-2 rounded-full mr-2 inline-block shrink-0 transition-all duration-300 ${connected ? "bg-[#4cd964] shadow-[0_0_6px_rgba(76,217,100,0.6)]" : "bg-[#ff3b30] shadow-[0_0_6px_rgba(255,59,48,0.6)]"}`}
        />
