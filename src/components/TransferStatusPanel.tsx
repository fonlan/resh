    ...
    <div className="bg-[var(--sidebar-bg,#1e1e1e)] border-t border-[var(--border-color,#333)] max-h-[200px] overflow-y-auto text-[12px]">
      ...
      <div className="flex flex-col">
        {tasks.map((task) => (
          <div
            key={task.task_id}
            className="flex items-center px-3 py-2 border-b border-[var(--border-color,#333)] gap-2"
          >
            ...
            <div className="flex-1 overflow-hidden min-w-0">
              <div
                className="whitespace-nowrap overflow-hidden text-ellipsis mb-1 text-[var(--text-color,#fff)]"
              ...
              <div className="h-1 bg-[var(--bg-color-dim,#333)] rounded overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${task.total_bytes > 0 ? (task.transferred_bytes / task.total_bytes) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
