        ...
        <div className="flex gap-4">
          {(["http", "socks5"] as const).map((type) => (
            ...
            >
              ...
              />
              <span className="text-sm text-zinc-400 group-hover:text-zinc-300 transition-colors uppercase">
                {type}
              </span>
            </label>
          ))}
          ...
          <div className="mb-4 p-3 bg-zinc-700/20 rounded-md border border-zinc-700/50">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleChange("ignoreSslErrors", e.target.checked)
                }
              ...
              <div>
                <span className="text-sm font-medium text-zinc-300 block">
                  {t.proxyForm.ignoreSslLabel}
                </span>
                <span className="text-xs text-zinc-500">
                  {t.proxyForm.ignoreSslDesc}
                </span>
              </div>
            </label>
          </div>
