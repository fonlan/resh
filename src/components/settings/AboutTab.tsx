...
export const AboutTab: React.FC = () => {
  ...
  return (
    <div
      className="flex flex-col items-center px-4 py-8 h-full overflow-y-auto relative"
      style={{
        backgroundImage:
    ...
    >
      <div className="flex flex-col items-center mb-10 text-center animate-[fadeIn_0.6s_cubic-bezier(0.22,1,0.36,1)_forwards]">
        ...
        <h1
          className="text-[2.5rem] font-extrabold m-0 "
          style={{
      ...
      <p
        className="max-w-[480px] text-center text-zinc-400 leading-[1.6] mb-12 text-[1.1rem] animate-[fadeIn_0.6s_cubic-bezier(0.22,1,0.36,1)_0.1s_forwards] opacity-0"
      ...
      <div
        className="grid grid-cols-2 gap-6 w-full max-w-[600px] mb-12 animate-[fadeIn_0.6s_cubic-bezier(0.22,1,0.36,1)_0.2s_forwards] opacity-0"
        style={{ animationFillMode: "forwards" }}
      >
      ...
      <div className="flex flex-wrap justify-center gap-3 mt-4 w-full max-w-[600px]">
        {techStack.map((tech) => (
          <span
            key={tech}
            className="bg-white/[0.05] text-zinc-300 px-3 py-1.5 rounded-lg text-sm border border-white/[0.05]"
          >
            {tech}
          </span>
        ))}
      ...
      <div
        className="mt-auto pt-12 text-center text-zinc-600 text-sm max-w-[400px] animate-[fadeIn_0.6s_cubic-bezier(0.22,1,0.36,1)_0.3s_forwards] opacity-0"
        style={{ animationFillMode: "forwards" }}
      >
